...
- Quick project session creation from `~/Dev`
...
- Visit the [Releases Page](https://github.com/chenasraf/tx/releases/latest) to download the
...
# Quick project session from ~/Dev
tx prj [name]
...
```bash
# Select from ~/Dev projects with fuzzy finder
tx prj
